...
export const STR = {
  ...
  'language.description': {
    1: 'Tento jazyk sa použije pre celú aplikáciu aj pre všetky skúšobné otázky.',
    2: 'This language will be used for the entire app and all exam questions.',
    3: 'Ez a nyelv lesz használva az egész alkalmazásban és minden vizsgakérdésben.',
  },
  'language.questionsNote': {
    1: 'Otázky budú v tomto jazyku',
    2: 'Questions will be in this language',
    3: 'A kérdések ezen a nyelven lesznek',
  },
  'language.lang1': {
    1: 'Slovenčina',
    2: 'Slovak',
  ...
  'onboarding.welcome.title': {
    1: 'Vodičák na Slovensku',
    2: 'Slovak Driving License',
    3: 'Szlovák Jogosítvány',
  },
  'onboarding.welcome.description': {
    1: 'Pripravte sa na teoretickú skúšku s oficiálnymi otázkami. Náš inteligentný systém sa prispôsobuje vášmu pokroku.',
    2: 'Prepare for the Slovak driving theory exam with official questions. Our smart system adapts to your progress.',
    3: 'Készüljön fel a szlovák elméleti vizsgára hivatalos kérdésekkel. Intelligens rendszerünk alkalmazkodik az Ön fejlődéséhez.',
  },
  'onboarding.smartStudy.title': {
    1: 'Učte sa efektívne',
    2: 'Study Smarter',
    3: 'Tanuljon okosabban',
  },
  'onboarding.smartStudy.description': {
    1: 'Náš algoritmus analyzuje vaše odpovede a automaticky sa zameriava na oblasti, kde potrebujete najviac precvičiť.',
    2: 'Our algorithm analyzes your answers and automatically focuses on areas where you need the most practice.',
    3: 'Algoritmusunk elemzi válaszait, és automatikusan azokra a területekre összpontosít, ahol a legtöbb gyakorlásra van szüksége.',
  },
  'onboarding.mistakes.title': {
    1: 'Žiadne chyby nezostanú',
    2: 'No Mistake Left Behind',
    3: 'Minden hiba számít',
  },
  'onboarding.mistakes.description': {
    1: 'Každá chyba je uložená a pripravená na opakovanie. Precvičujte ich, kým ich nebudete mať v malíčku.',
    2: 'Every mistake is saved and ready for review. Practice them until they become second nature.',
    3: 'Minden hiba mentve van és készen áll az áttekintésre. Gyakorolja őket, amíg természetessé nem válnak.',
  },
  ...
  'onboarding.mockExam.description': {
    1: 'Simulujte skutočnú skúšku s časovým limitom 30 minút. Presne viete, či ste pripravení.',
    2: 'Simulate the real exam with a 30-minute time limit. Know exactly when you\'re ready.',
    3: 'Szimulálja a valódi vizsgát 30 perces időkorláttal. Tudja pontosan, mikor áll készen.',
  },
  'onboarding.progress.title': {
    1: 'Vidíte svoj pokrok',
    2: 'Watch Yourself Improve',
    3: 'Figyelje fejlődését',
  },
