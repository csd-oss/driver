...
export const STR = {
  ...
  'crossing.vehicle.other': { 1: 'iné vozidlo', 2: 'the other vehicle', 3: 'a másik jármű' },
  'guide.lesson.tramYield.title': { 1: 'Električka na vedľajšej ceste', 2: 'Tram on a side road', 3: 'Villamos a mellékúton' },
  'guide.lesson.tramYield.goal': { 1: 'Si na hlavnej ceste. Električka na vedľajšej ceste ti dáva prednosť. Pokračuj, keď je bezpečne.', 2: 'You are on the main road. The tram on the side road gives way to you. Continue when safe.', 3: 'A főúton haladsz. A mellékútról érkező villamos elsőbbséget ad. Haladj tovább, ha biztonságos.' },
  'guide.continuous.title': { 1: 'Jazda s inštruktorom', 2: 'Drive with an instructor', 3: 'Vezetés oktatóval' },
  'guide.continuous.body': { 1: 'Jedna súvislá jazda od jednoduchých križovatiek po kruhový objazd. Inštruktor ti poradí, keď situáciu uvidíš. Chyby si vysvetlíme počas jazdy.', 2: 'One continuous drive, from simple junctions to a roundabout. Your instructor gives hints when the situation is in view and explains mistakes as you go.', 3: 'Egy folyamatos út az egyszerű kereszteződésektől a körforgalomig. Az oktató akkor segít, amikor a helyzet látható, és menet közben elmagyarázza a hibákat.' },
  'guide.continuous.observe': { 1: 'Sleduj cestu. Ku križovatke sa ešte len blížime.', 2: 'Watch the road. We are still approaching the junction.', 3: 'Figyeld az utat. Még közeledünk a kereszteződéshez.' },
  'guide.continuous.tramStreet': { 1: 'Zostaň v jazdnom pruhu vedľa koľají. Na najbližšej križovatke odboč doprava.', 2: 'Stay in the road lane beside the tracks. Turn right at the next junction.', 3: 'Maradj a sínek melletti forgalmi sávban. A következő kereszteződésnél fordulj jobbra.' },
  'guide.continuous.driving': { 1: 'Pokračujeme v jazde', 2: 'Continuing the drive', 3: 'Folytatjuk a vezetést' },
  'guide.continuous.safe': { 1: 'Dobre, bezpečne prejdené. Pokračuj.', 2: 'Safely through. Keep going.', 3: 'Biztonságosan áthaladtál. Haladj tovább.' },
  'guide.continuous.review': { 1: 'Na precvičenie', 2: 'To practise again', 3: 'Ismétlendő' },
  'guide.continuous.controls': { 1: 'Použi tlačidlá alebo potiahni po ceste: doľava či doprava vyberá smer, nadol brzdí a nahor rozbieha.', 2: 'Use the buttons or swipe on the road: left or right to turn, down to brake, up to go.', 3: 'Használd a gombokat, vagy húzz az úton: balra és jobbra irányt választasz, lefelé fékezel, felfelé elindulsz.' },
  'crossing.coach.observe': { 1: 'Sleduj premávku, kým sa blížime.', 2: 'Watch traffic as we approach.', 3: 'Figyeld a forgalmat, ahogy közeledünk.' },
  'crossing.control.direction': { 1: 'Smer', 2: 'Direction', 3: 'Irány' },
  'crossing.control.swipe': { 1: 'Potiahni', 2: 'Swipe', 3: 'Húzd' },
  'crossing.control.pedals': { 1: 'Pedále', 2: 'Pedals', 3: 'Pedálok' },
  'crossing.control.instructor': { 1: 'Inštruktor', 2: 'Instructor', 3: 'Oktató' },
  'crossing.control.practice': { 1: 'Cvičná jazda', 2: 'Practice drive', 3: 'Gyakorló vezetés' },
  'crossing.control.lessonHint': { 1: 'Použi tlačidlá alebo potiahni po ceste.', 2: 'Use the buttons or swipe on the road.', 3: 'Használd a gombokat, vagy húzz az úton.' },
  'crossing.control.left': { 1: 'Vľavo', 2: 'Left', 3: 'Balra' },
  'crossing.control.right': { 1: 'Vpravo', 2: 'Right', 3: 'Jobbra' },
  'crossing.control.brake': { 1: 'Zastaviť', 2: 'Stop', 3: 'Megállás' },
  'crossing.control.go': { 1: 'Rozjazd', 2: 'Go', 3: 'Indulás' },
  'crossing.control.pause': { 1: 'Pozastaviť', 2: 'Pause', 3: 'Szünet' },
  'crossing.control.resume': { 1: 'Pokračovať', 2: 'Resume', 3: 'Folytatás' },
  'crossing.control.paused': { 1: 'Jazda pozastavená', 2: 'Drive paused', 3: 'Szünet' },
  'crossing.control.driving': { 1: 'Sleduj cestu a premávku', 2: 'Watch the road and traffic', 3: 'Figyeld az utat és a forgalmat' },
  'crossing.control.braking': { 1: 'Spomaľovanie k čiare', 2: 'Slowing to the line', 3: 'Lassítás a vonalig' },
  'crossing.control.waiting': { 1: 'Stojíš · rozhliadni sa', 2: 'Stopped · take time to look', 3: 'Állsz · nézz körül' },
  'crossing.runnerHint': {
    1: 'Pokračuj rovno, ak inštruktor nepovie inak.',
    2: 'Continue straight unless the instructor says otherwise.',
    3: 'Haladj egyenesen, ha az oktató mást nem mond.',
  },
  'crossing.hesitated': {
  ...
  'crossing.levelUp': {
    1: 'Úroveň {n}. Nové situácie.',
    2: 'Level {n}. New situations.',
    3: '{n}. szint. Új helyzetek.',
  },
  ...
  'crossing.legendDown': {
    1: 'Zastaviť alebo potiahnuť nadol: zastav pri čiare',
    2: 'Tap Stop or swipe down: stop at the line',
    3: 'Megállás gomb vagy húzás lefelé: állj meg a vonalnál',
  },
  'crossing.legendUp': {
    1: 'Rozjazd alebo potiahnuť nahor: rozbehni sa, keď je voľno',
    2: 'Tap Go or swipe up: move off when safe',
    3: 'Indulás gomb vagy húzás felfelé: indulj el, ha biztonságos',
  },
  'crossing.legendSide': {
    1: 'Potiahni doľava alebo doprava: odboč podľa inštruktora',
    2: 'Tap an arrow or swipe sideways to select a turn',
    3: 'Húzz balra vagy jobbra: fordulj az oktató szerint',
  },
  'crossing.legendRules': {
    1: 'Bezpečnosť má prednosť. Za opatrné zastavenie ani čakanie nestrácaš body. Smerovka auto nerozbehne.',
    2: 'Safety comes first. Cautious stops and waiting cost no points. Selecting a turn never moves you off.',
    3: 'A biztonság az első. Az óvatos megállás és várakozás nem jár pontlevonással. Az irányjelzés nem indítja el az autót.',
  },
  'crossing.coach.giveWay': {
    1: 'Prednosť má {vehicle}. Stlač Zastaviť a počkaj.',
    2: '{vehicle} has priority. Tap Stop and wait.',
    3: '{vehicle} elsőbbséget élvez. Nyomd meg a Megállás gombot, és várj.',
  },
  'crossing.coach.priority': {
    1: 'Máš prednosť. Pokračuj, keď je bezpečne.',
    2: 'You have priority. Continue when safe.',
    3: 'Tiéd az elsőbbség. Haladj tovább, ha biztonságos.',
  },
  'crossing.coach.turn': {
    1: 'Šípkou vyber smer {dir}.',
    2: 'Select the {dir} arrow to turn.',
    3: 'A nyíllal válaszd a(z) {dir} irányt.',
  },
  ...
  'crossing.coach.stopSign': {
    1: 'Značka STOP: stlač Zastaviť. Po úplnom zastavení stlač Rozjazd, keď je voľno.',
    2: 'STOP sign: tap Stop. Come to a complete stop, then tap Go when clear.',
    3: 'STOP tábla: nyomd meg a Megállás gombot. Teljes megállás után válaszd az Indulást, ha szabad az út.',
  },
  'crossing.coach.goSwipe': {
    1: 'Voľno. Stlač Rozjazd a pokračuj.',
    2: 'The way is clear. Tap Go to move off.',
    3: 'Szabad az út. Nyomd meg az Indulás gombot.',
  },
  ...
  'guide.lesson.mainRoad.goal': {
    1: 'Žltý kosoštvorec znamená hlavnú cestu. Máš prednosť. Pred pokračovaním skontroluj premávku.',
    2: 'The yellow diamond means main road. You have priority. Check traffic before continuing.',
    3: 'A sárga rombusz főutat jelent. Tiéd az elsőbbség. Továbbhaladás előtt ellenőrizd a forgalmat.',
  },
  ...
  'guide.lesson.turn.goal': {
    1: 'Inštruktor ti povie smer. Šípkou doprava alebo doľava vyber odbočenie.',
    2: 'The instructor tells you the way. Choose your turn with the right or left arrow.',
    3: 'Az oktató megmondja az irányt. A jobbra vagy balra mutató nyíllal válaszd ki a kanyart.',
  },
  ...
  'guide.lesson.leftTurn.goal': {
    1: 'Vyber ľavú šípku. Pri odbočení vľavo dávaš prednosť vozidlám, ktoré idú oproti.',
    2: 'Select the left arrow. When turning left, give way to oncoming traffic.',
    3: 'Válaszd a bal nyilat. Balra kanyarodáskor adj elsőbbséget a szemből jövőknek.',
  },
  ...
  'guide.lesson.tram.goal': {
    1: 'Táto električka prichádza sprava na križovatke bez značiek. Daj jej prednosť. Aj električky sa riadia značkami a signálmi.',
    2: 'This tram comes from your right at an unsigned junction. Give way. Trams also obey signs and signals.',
    3: 'Ez a villamos jobbról érkezik a táblák nélküli kereszteződésbe. Adj elsőbbséget. A villamosokra is vonatkoznak a táblák és jelzések.',
  },
  ...
  'guide.lesson.roundabout.goal': {
    1: 'Daj prednosť vozidlám v kruhu, potom pokračuj. Pred svojím výjazdom vyber pravú šípku.',
    2: 'Give way to traffic in the ring, then continue. Select the right arrow just before your exit.',
    3: 'Adj elsőbbséget a körben haladóknak, majd haladj tovább. A kijáratod előtt válaszd a jobb nyilat.',
  },
  'guide.title': {
    1: 'Sprievodca',
    2: 'Guide',
  ...
  'guide.hint.redLight': {
    1: 'Červená. Stlač Zastaviť.',
    2: 'Red light. Tap Stop.',
    3: 'Piros. Nyomd meg a Megállás gombot.',
  },
  'guide.hint.ring': {
    1: 'Tvoj výjazd. Vyber pravú šípku.',
    2: 'Your exit. Select the right arrow.',
    3: 'A kijáratod. Válaszd a jobb nyilat.',
  },
  'guide.watch': {
